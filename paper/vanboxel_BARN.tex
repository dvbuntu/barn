...
\section{Computational Costs of BARN}\label{sec:cost}

\crp{Add a new section assessing how computationally expensive BARN is...for instance, you could use microbenmark in R for this.  https://cran.r-project.org/web/packages/microbenchmark/index.html}
